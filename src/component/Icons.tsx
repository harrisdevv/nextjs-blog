...
export const SunIcon: FC<SVGProps<SVGSVGElement>> = ({ className, ...rest }) => (
  <svg
    ...
    viewBox="0 0 24 24"
    {...rest}
    className={concateBooleanClass("w-full h-auto", className || "")}
  >
...
export const MoonIcon: FC<SVGProps<SVGSVGElement>> = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const LinkedinIcon: FC<SVGProps<SVGSVGElement>> = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const TwitterIcon : FC<SVGProps<SVGSVGElement>> = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const GithubIcon : FC<SVGProps<SVGSVGElement>> = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const DribbbleIcon : FC<SVGProps<SVGSVGElement>> = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
